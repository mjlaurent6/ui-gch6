...
import DeviceSearch, {DeviceSearchUpLink, RxInfo} from "../views/devices/DeviceSearch";

export type TDeviceUpLink = {
...
class DeviceStore extends EventEmitter {
    ...
    getSearchLocation = (
        ...
        axios.get<TDeviceUpLink>(
            `http://localhost:8000/localization/distance?device_eui=${deviceEui}&limit=${queryLimit}`, {
                headers: {
